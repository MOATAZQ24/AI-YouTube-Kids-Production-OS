...
1. **Review the [Architecture](ARCHITECTURE.md)**: Understand how the different components of the OS interact.
2. **Configure Knowledge Base**: Populate the `knowledge/` directory with your brand and character details.
3. **Set Up Automations**: Check the `automation/` folder for n8n and API integration guides.
4. **Execute Workflows**: Follow the production steps in `workflows/` to generate your first episode.
